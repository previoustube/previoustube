// From: https://github.com/lvgl/lv_port_pc_eclipse/blob/release/v8.3/lv_conf.h
...
#define LV_MEM_CUSTOM 0
   ...
   #define LV_MEM_SIZE (8192 * 1024U)          /*[bytes]*/
...
#if LV_TICK_CUSTOM
   #define LV_TICK_CUSTOM_INCLUDE "lvgl_sdl_tick_millis.h"         /*Header for the system time function*/
...
#define LV_ASSERT_HANDLER_INCLUDE "my_assert.h"
#define LV_ASSERT_HANDLER my_assert(__FILE__, __LINE__);
...
#define LV_USE_FS_STDIO 1
   ...
   #define LV_FS_STDIO_PATH "../../main/"         /*Set the working directory. File/directory paths will be appended to it.*/
